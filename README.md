...
* **Canon modular espacial:** Unidad maestra u0 = 70.0 px y pautado en tercios u0 / 3 = 23.3 px.
* **Sintaxis de ranuras operacionales:** Autómata finito determinista gobernado por la regla W = P + R + S.
* **Fórmula de clausura scribal:** Desinencia terminal `daiin` = *[tammat]* (fin de prescripción, 100% de absorción de entropía).
* **Cobertura en sección de botica (f87r–f102v):** 100.0% determinista sobre 121 tokens de prescripciones.
