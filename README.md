...
* **Canon modular espacial:** Unidad maestra u0 = 70.0 px y pautado en tercios u0 / 3 = 23.3 px[span_0](start_span)[span_0](end_span)[span_1](start_span)[span_1](end_span).
...
`[f71v: Zodiaco]` → `[f1r/f17r: Herbario]` → `[f86v: Destilación Rosetas]` → `[f78r/f79r: Balneoterapia]` → `[f89r: Farmacia/Albarelos]`[span_13](start_span)[span_13](end_span)[span_14](start_span)[span_14](end_span)[span_15](start_span)[span_15](end_span)
